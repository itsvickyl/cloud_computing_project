...
const ResultCard = memo<ResultCardProps>(({ rank }) => {
  const { user, resumeLink, rank: ranked, score } = rank;
    ...
    <Card className="relative mb-4 border border-border/50 hover:border-primary/50 hover:shadow-lg hover:shadow-primary/5 transition-all duration-300 overflow-hidden bg-card/50 backdrop-blur-sm">
      <CardContent className="py-2 px-4">
        <div className="flex flex-col items-center md:flex-row gap-4 md:gap-5">
          <h3 className="text-xl">{ranked}.</h3>
          ...
          <div className="flex-1 space-y-3">
            <div className="hidden md:block">
              ...
              <p className="text-sm underline text-blue-500 underline-offset-1 font-medium">
